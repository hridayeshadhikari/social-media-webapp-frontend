...
import { CREATE_STORY_FAILURE, CREATE_STORY_REQUEST, CREATE_STORY_SUCCESS, GET_STORY_FAILURE, GET_STORY_REQUEST, GET_STORY_SUCCESS } from "./story.actionType"
...
export const getAllStory=(userId)=>async (dispatch)=>{
    ...
    try {
        const {data}=await api.post(`/api/stories/${userId}`)
